...
export class BannerService {
  private bannerData: { [key: string]: { image: string; text: string; alt: string; title: string; } } = {
    ...
    '/gallery': { image: 'assets/img/bee_removal_services.jpg', text: 'Gallery' , title: 'Honey Bees from bee removal service', alt: 'Queen and worker bees during a live honey bee removal, illustrating safe relocation to protect the hive and bees.'},
